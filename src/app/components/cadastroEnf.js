...
const CadastroEnf = ()=> {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
          await addDoc(collection(db, 'cadastro'), form);
    ...
    return(
      ...
      <form onSubmit={handleSubmit} style={formStyle}>
        <select style={inputStyle} type="text" name="curso" value={form.curso} onChange={handleChange}>
        ...
        <input
          ...
          style={inputStyle}
        />
        <button type="submit" style={buttonStyle}>Inscreva-se Agora!</button>
      </form>
    </div>
    </div>
    </div>

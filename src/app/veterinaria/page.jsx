...
export default function Veterinaria(){
  ...
  fontFamily: 'Bree GRK', fontSize:"30px",  display:"flex", flexDirection:"column", paddingBottom:'5rem', paddingTop:'5rem'}}>
        <a id="btn_fixo" href="https://wa.me/5511973799471?text=Estou%20vindo%20do%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20curso%20técnico%20em%20Veterinária"target="_blank" rel="noopener noreferrer">
        <Image
